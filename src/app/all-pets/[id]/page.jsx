...
export default function PetDetailsPage({ params: paramsPromise }) {
    ...
    // ডেমো লগইন ইউজার (আপনার অথেন্টিকেশন অনুযায়ী এটি ডাইনামিক হবে)
    const user = {
        name: 'Nayem Ahmed',
        email: 'nayem@gmail.com'
    };
    ...
    const handleAdoptSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 400 || result.alreadyAdopted) {
                // যদি আগে থেকেই অ্যাডপ্ট করা থাকে বা সার্ভার থেকে এরর আসে
                toast.error(result.message || "You have already submitted a request for this pet!");
            } else if (response.ok) {
                // সফল হলে সাকসেস টোস্ট দেখাবে এবং My Requests পেজে নিয়ে যাবে
                toast.success("Adoption request submitted successfully!");
                
                setTimeout(() => {
                    router.push('/dashboard/my-request');
                }, 1500); // ১.৫ সেকেন্ড পর রিডাইরেক্ট হবে যাতে টোস্টটি দেখা যায়
            } else {
